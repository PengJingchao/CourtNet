...
class VisionTransformer(nn.Module):  #768, 12
    def __init__(self, img_size=224, patch_size=16, in_c=3, num_classes=1000,
        ...
        self.decoder_pred = nn.Linear(embed_dim, patch_size ** 2 * 1, bias=True)  # decoder to patch
...
if __name__ == '__main__':
    ...
    model = VisionTransformer()  # 16.89 GMac 86.0 M
    print(model)
    out = model(input)
    print('out.shape:')
    print(out.shape)
